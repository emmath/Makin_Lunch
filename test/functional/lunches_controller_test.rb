...
class LunchesControllerTest < ActionController::TestCase
  ...
  test "should create lunch" do
    assert_difference('Lunch.count') do
      post :create, lunch: { date: @lunch.date, food_id: @lunch.food_id, meal_id: @lunch.meal_id, occasion: @lunch.occasion }
    end
  ...
  test "should update lunch" do
    put :update, id: @lunch, lunch: { date: @lunch.date, food_id: @lunch.food_id, meal_id: @lunch.meal_id, occasion: @lunch.occasion }
    assert_redirected_to lunch_path(assigns(:lunch))
  end
